...
const PROJECTS = {
  ...
  theroom: {
    ...
    services: "Uzbek Fusion Dining, Brand Identity, Motion Design",
    deliverables: "Digital Brand System, Interactive Brand Showcase, Motion Assets",
    overview: `The Room is a premium Uzbek fusion dining and karaoke lounge. We translated the warm, immersive atmosphere and rich cultural flavor of their culinary space into a distinct, high-contrast, edge-to-edge brand experience.<br><br>Features a customized interactive showcase and atmospheric photography layouts designed to evoke sensory connection and high engagement.`,
  ...
  arena: {
    ...
    services: "Creative Direction, Branding, Motion Design",
    deliverables: "Brand Guidelines, Motion Framework, Visual Narrative",
    overview: `ABP Arena Project is an elite relocation and luxury logistics showcase. Designed as a high-fidelity brand experience, the showcase conveys absolute security, extreme precision, and premium service execution.<br><br>Leveraging state-of-the-art visual timelines and GSAP animations, the motion narrative guides users through complex logistics stories with absolute fluidity.`,
